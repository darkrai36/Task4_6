package ru.vsu.cs.sis.task4.util;
...
public class ArrayUtils {
    ...
    */
    ...
    public static double[] createRandomDoubleArray(int length, double minValue, double maxValue) {
        ...
        int bound = (int) (maxValue - minValue);
        for (int i = 0; i < length; i++)
            arr[i] = minValue + RND.nextInt(bound);
        return arr;
    }
    ...
    // добавила
    public static double[][] createRandomDoubleMatrix(int rowCount, int colCount, double minValue, double maxValue) {
